    ...
    function min_qty_indicator(product){
        ...
        data_tagArray.forEach(function(v,i){
          if(v.indexOf("min-qty:")> -1){
            ...
            html = ` <p>Minimum of <b>${qtyTagArray[1]}</b> <span class="popup_minq"><a href="#one" class="fancybox"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
