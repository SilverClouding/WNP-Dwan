...
//             $('.option.' + opt.toLowerCase()).append('<option value="' + value + '">' + value + '</option>');
    ...
    $('.option.' + opt.toLowerCase()).append('<input class="radio_butt" index="'+i+'" type="radio" id="'+opt.toLowerCase()+''+value.toLowerCase()+'" name="'+opt+'" value="'+value+'" form=""><label for="'+opt.toLowerCase()+''+value.toLowerCase()+'">'+value+'</label>');
