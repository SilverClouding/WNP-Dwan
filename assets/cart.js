...
//     custom
    this.updateQuantity(event.target.dataset.index, document.activeElement.getAttribute('updateqty'), document.activeElement.getAttribute('name'));
  }
  ...
  updateQuantity(line, quantity, name) {
    ...
    fetch(`${routes.cart_change_url}`, {...fetchConfig(), ...{ body }})
      ...
      document.getElementById('MainContent').classList.toggle('main-empty-class', parsedState.item_count === 0);
        ...
        window._swat.initializeActionButtons('.cart__items', '.swym-button');
